...
int main(int argc, char **argv) {
    ...
    proj1::EmbeddingHolder users("data/q3.in");
    proj1::EmbeddingHolder items("data/q3.in");
    proj1::Instructions instructions = proj1::instr_from_file("data/q3_instruction.tsv");
