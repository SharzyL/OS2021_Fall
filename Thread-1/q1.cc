...
int main(int argc, char **argv) {
    ...
    proj1::EmbeddingHolder users("data/q1.in");
    proj1::EmbeddingHolder items("data/q1.in");
    proj1::Instructions instructions = proj1::instr_from_file("data/q1_instruction.tsv");
